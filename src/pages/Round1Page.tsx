...
const PhaseItem = (props: { i: number; Round1_MultiData: Round1_Data_Naibu ,stage_no:number}) => {
    const score = props.Round1_MultiData.teams[props.i].score;
/*
    const color = score < 1 ? LOST : score === 1 ? REACH : NORMAL
    */
   const color=NORMAL;
